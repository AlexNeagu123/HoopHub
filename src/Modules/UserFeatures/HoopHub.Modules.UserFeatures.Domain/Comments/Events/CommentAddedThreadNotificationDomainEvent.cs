...
{
    public class CommentAddedThreadNotificationDomainEvent(string recipientId, string senderId, string title, string content, string? senderImageUrl, string? attachedNavigationData) : DomainEventBase
    {
